...
var _chunkVRKVKT62js = require('./chunk-VRKVKT62.js');
...
var _FetchInterceptor = class extends _chunkTIPR373Rjs.Interceptor {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const controller = new (0, _chunkVRKVKT62js.RequestController)(request);
      ...
      const isRequestHandled = await _chunkVRKVKT62js.handleRequest.call(void 0, {
        request,
        requestId,
        ...
        onResponse: async (response) => {
          ...
          if (this.emitter.listenerCount("response") > 0) {
            ...
            await _chunkVRKVKT62js.emitAsync.call(void 0, this.emitter, "response", {
...
//# sourceMappingURL=chunk-6MBJUL74.js.map